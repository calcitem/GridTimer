...
if [ "$CURRENT_BRANCH" != "master" ] && [ "$CURRENT_BRANCH" != "main" ] && [ "$CURRENT_BRANCH" != "cursor/release-script-execution-and-formatting-4138" ] && [ "$CURRENT_BRANCH" != "cursor/flutter-environment-and-release-ad8a" ]; then
